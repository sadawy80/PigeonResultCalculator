...
export const WORLD_COUNTRIES: { name: string; code: string }[] = [
...
export function getCountriesWithFlags(): CountryOption[] {
  return WORLD_COUNTRIES.map(c => ({ ...c, flag: flagEmoji(c.code) }));
}
