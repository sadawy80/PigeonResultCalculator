...
public interface ISubscriptionService
{
    ...
    Task<Result<PagedResult<FederationSubscriptionDto>>> GetFederationSubscriptionsAsync(int page, int pageSize, CancellationToken ct = default);
    ...
    // Internal validation
    Task<SubscriptionValidationResult?> ValidateCountryAsync(Guid FederationId, CancellationToken ct = default);
